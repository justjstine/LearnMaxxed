...
import VideoMaterials.ICT.Controllers.IllustrationChap2VidController;
...
public class IllustrationChap2Controller {
    ...
    public void premnextButtonHandler(javafx.event.ActionEvent event) throws IOException {
        Parent nextRoot = FXMLLoader.load(getClass().getResource("/LearningMaterials/Premium/IllustrationChap3.fxml"));
        Stage stage = (Stage) ((Button) event.getSource()).getScene().getWindow();
    ...
    public void playVidHandler(javafx.event.ActionEvent event) throws IOException {
        Parent vidRoot = FXMLLoader.load(getClass().getResource("/VideoMaterials/ICT/FXML/IllustrationChap2Vid.fxml"));
        ...
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/VideoMaterials/ICT/FXML/IllustrationChap2Vid.fxml"));
        Parent root = loader.load();
        IllustrationChap2VidController controller = loader.getController();

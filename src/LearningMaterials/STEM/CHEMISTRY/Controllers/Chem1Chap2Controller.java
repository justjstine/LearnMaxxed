...
public class Chem1Chap2Controller {
    ...
    public void chem1ButtonHandler(javafx.event.ActionEvent event) throws IOException {
        Parent chem1Root = javafx.fxml.FXMLLoader.load(getClass().getResource("/LearningMaterials/STEM/Chemistry/FXML/ChemChapter1.fxml"));
        Stage stage = (Stage) ((Button) event.getSource()).getScene().getWindow();
    ...
    public void premchem1ButtonHandler(javafx.event.ActionEvent event) throws IOException {
        Parent chem1Root = javafx.fxml.FXMLLoader.load(getClass().getResource("/LearningMaterials/Premium/ChemChapter1.fxml"));
        Stage stage = (Stage) ((Button) event.getSource()).getScene().getWindow();
        stage.setScene(new Scene(chem1Root, 1000, 600));
    }
    ...
    public void nextButtonHandler(javafx.event.ActionEvent event) throws IOException {
        Parent nextRoot = javafx.fxml.FXMLLoader.load(getClass().getResource("/LearningMaterials/STEM/Chemistry/FXML/ChemChapter3.fxml"));
        Stage stage = (Stage) ((Button) event.getSource()).getScene().getWindow();
    ...
    public void premNextButtonHandler(javafx.event.ActionEvent event) throws IOException {
        Parent nextRoot = javafx.fxml.FXMLLoader.load(getClass().getResource("/LearningMaterials/Premium/ChemChapter3.fxml"));
        Stage stage = (Stage) ((Button) event.getSource()).getScene().getWindow();
        stage.setScene(new Scene(nextRoot, 1000, 600));
    }

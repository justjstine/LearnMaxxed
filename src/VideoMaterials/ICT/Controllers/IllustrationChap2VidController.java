...
public class IllustrationChap2VidController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        file = new File("Videos/Photoshop Tutorial for Beginners 2022 _ Everything You NEED to KNOW!.mp4");
        if (file.exists()) {
